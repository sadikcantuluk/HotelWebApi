...
namespace HotelProject.WebUI.ViewvComponents.Dashboard
{
    public class _DashboardWidgetPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage3 = await client3.GetAsync("http://localhost:5150/api/DashboardWidget/GetRoomCount");
            var jsonData3 = await responseMessage3.Content.ReadAsStringAsync();
            ViewBag.roomCount = jsonData3;

            var client4 = _httpClientFactory.CreateClient();
            var responseMessage4 = await client4.GetAsync("http://localhost:5150/api/DashboardWidget/GetAppUserCount");
            var jsonData4 = await responseMessage4.Content.ReadAsStringAsync();
            ViewBag.appUserCount = jsonData4;
