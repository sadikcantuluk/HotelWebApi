...
{
    public partial class add_booking_mig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Giriş = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Çıkış = table.Column<DateTime>(type: "datetime2", nullable: false),
